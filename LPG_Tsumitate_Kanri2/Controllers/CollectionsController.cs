...
public class CollectionsController : Controller
{
    ...
    public async Task<IActionResult> Reopen(int id)
    {
        ...
        var entry = await _db.LedgerEntries
            .FirstOrDefaultAsync(e => e.SourceSessionId == id && e.IsAutoGenerated);

        if (entry != null)
        {
            var entryDate = entry.TransactionDate;
            ...
            await _ledgerService.RecalculateFromAsync(savingsTypeId, entryDate, entryId);
        }
